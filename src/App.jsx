...
// Bonus matrix: Amazon Scorecard × Weekly Rating × Tier × Tenure
const BONUS_MATRIX = {
  "Fantastic Plus": {
...
export default function App() {
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto font-sans">
      ...
      <div className="space-y-4 bg-white p-6 rounded shadow-md">
        ...
        {role !== "Driver" && (
          <>
            ...
            <p className="text-xs text-gray-500">* Enter Trainer/Supervisor base rate</p>
          </>
        )}
      ...
      {/* Netradyne & FAQ */}
      {checkND && (
        <div className="mt-4 bg-green-50 p-6 rounded-lg space-y-6">
          ...
          <div className="text-sm space-y-4">
            ...
            <div>
              ...
              <p>Only Perfect and Meets Requirements are eligible for bonus.</p>
            </div>
            ...
            <div>
              ...
              <p>Block-level penalties last for 2 weeks. Load-level penalties last for 6 weeks.</p>
            </div>
            ...
            <div>
              ...
              <p>If eligible, your Netradyne bonus accrues weekly and pays out as a lump sum each quarter.</p>
            </div>
