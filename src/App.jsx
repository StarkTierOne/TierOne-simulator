    ...
    <div className="p-8 max-w-3xl mx-auto font-sans space-y-8">
        ...
        <div className="bg-green-50 p-6 rounded-lg shadow space-y-4">
          ...
          {showNDE && (
            <div className="text-sm pl-4">
              ...
              a lump sum at the end of each quarter.
            </div>
          )}
        </div>
      )}
      ...
      <div className="bg-white p-6 rounded-lg shadow space-y-4">
        ...
        <ul className="list-disc ml-6 space-y-1">
          ...
          <li>
            Hourly Bonus Total Pay (Max 40 hrs): ${hourlyBonusTotal}
          </li>
          <li>
        ...
        {showFAQ && (
          <div className="text-sm space-y-4 pl-4">
            ...
            <div>
              ...
              {showPG && (
                <div className="mt-1">
                  ...
                  overall Total Score.
                  <br />
                  A Grade: 10 weeks at 100%, rest at 90%+, 1 grace week at
                  70%+
                  <br />
                  B Grade: 5 weeks at 100%, rest at 90%+, 1 grace week at
                  70%+ or all 13 weeks at 90%+
                  <br />
                  ...
                  combination of each
                  <br />
                  F Grade: 5+ weeks below 70% or all 13 weeks between 70–83% or
            ...
            <div>
              ...
              {showWR && (
                <div className="mt-1">
                  Weekly Rating reflects how you performed this week — it's
                  based on your Total Score plus any safety, attendance, or
                  behavioral flags.
                  <br />
                  Perfect: 100% score with zero flags
                  <br />
                  Meets Requirements: 83–99% with no flags, or 100% with 1
                  minor flag
                  <br />
                  Needs Improvement: 70–82.99%, or 83–99% with 1 minor flag
                  <br />
                  Action Required: Less than 70%, or any score with 3+ minor
                  flags or 1 major flag
                </div>
              )}
            </div>
            {/* 3 */}
            <div>
              ...
              {showCP && (
                <div className="mt-1">
                  • Block Level Callouts = Calling out before the trip has
                  populated with stops
                  <br />
                  • Load Level Callouts = Calling out after the trip has
                  populated with stops (trips usually populate 16–18 hours
                  before a trip start)
                  <br />
                  <br />
            ...
            <div>
              ...
              {showST && (
                <div className="mt-1">
                  ...
                  grants access to the 5+ year payband — even if you haven't
                  reached 5 years of tenure yet. However, you must maintain
                  Perfect rating to stay in S-Tier.
                </div>
              )}
            </div>
            {/* 5 */}
            <div>
              ...
              {showDQ && (
                <div className="mt-1">
                  ...
                  <br />
                  • You receive a major safety flag (e.g., camera, following
                  distance, seatbelt)
                  <br />
            ...
            <div>
              ...
              {showNDW && (
                <div className="mt-1">
                  ...
                  in the last 6 weeks
                  <br />
                  If eligible, your Netradyne bonus accrues weekly and is paid
                  out in a lump sum at the end of each quarter.
                </div>
              )}
            </div>
            {/* Links */}
