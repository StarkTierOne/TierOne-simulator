...
export default function App() {
  ...
  const is39Elig = check39 && role==="Driver" && rating==="Perfect" && (parseInt(daysWorked,10)||0)>=3 && driverRejects==="No";
  ...
  const lunchAmt = isLunchElig?((parseInt(daysWorked,10)||0) * lunchRate):0;
