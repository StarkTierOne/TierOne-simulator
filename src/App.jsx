    ...
    <div className="p-8 max-w-3xl mx-auto font-sans space-y-8">
        ...
        {role === "Driver" && rating === "Perfect" && (
          <div className="flex items-center space-x-2">
            <input
              ...
              className="w-5 h-5"
            />
            <label htmlFor="g39Toggle" className="font-medium">
        ...
        {role === "Driver" && rating === "Perfect" && ["A", "B"].includes(tier) && (
          <div className="flex items-center space-x-2">
            <input
              ...
              className="w-5 h-5"
            />
            <label htmlFor="lunchToggle" className="font-medium">
        ...
        <div className="bg-green-50 p-6 rounded-lg shadow space-y-4">
          ...
          {showNDE && (
            <div className="text-sm pl-4">
              The Netradyne Bonus is paid out quarterly if the company earns Gold or
              Silver status on Amazon's camera safety score. You must not have NI or AR
              ratings or receive major camera flags to qualify. If eligible, your bonus
              accrues weekly and is paid as a lump sum at the end of the quarter.
            </div>
          )}
        </div>
      )}
        ...
        <div className="bg-blue-50 p-6 rounded-lg shadow space-y-4">
          ...
          {show39Exp && (
            <div className="text-sm pl-4">
              ...
              driver-initiated rejects, we’ll credit you up to 39 hours at your base
              rate even if you actually worked fewer.
            </div>
          )}
          <div>
      ...
      {checkLunch && (
        <div className="bg-yellow-50 p-6 rounded-lg shadow space-y-4">
          ...
          {showLunchExp && (
            <div className="text-sm pl-4">
              As long as you have a Perfect rating and Grade A or B, you earn a lunch
              bonus for each day worked. Enter your per-day rate below.
            </div>
          )}
          <div>
        ...
        <ul className="list-disc ml-6 space-y-1">
          <li>
            ...
            {hours ? (
              ...
              <span
                className="text-gray-400 italic underline cursor-pointer"
                onClick={focusHours}
              >
                $0.00 (enter hours)
              </span>
            ...
            <div>
              ...
              {showPG && (
                <div className="mt-1">
                  ...
                  <p>
                    <strong>F Grade:</strong> 5+ weeks below 70% or all 13
                    weeks between 70–83%
                  </p>
                </div>
              )}
            ...
            <div>
              ...
              {showWR && (
                <div className="mt-1">
                  ...
                  <p>
                    <strong>Needs Improvement:</strong> 70–82.99%, or 83–99%
                    with minor flags
                  </p>
                  <p>
            ...
            <div>
              ...
              {showNDW && (
                <div className="mt-1">
                  ...
                  <p>
                    If eligible, your bonus accrues weekly and is paid as a
                    lump sum at the end of each quarter.
                  </p>
                </div>
              )}
            </div>
