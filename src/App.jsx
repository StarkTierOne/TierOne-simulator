    ...
    <div className="p-8 max-w-3xl mx-auto font-sans space-y-8">
      ...
      <div className="bg-white p-6 rounded-lg shadow space-y-6">
        ...
        <div>
          ...
          <input id="hours" type="number" value={hours} onChange={e=>setHours(e.target.value)}
            placeholder="e.g. 38.5" className="w-full border p-2 rounded" />
        </div>
        ...
        {(role==="Trainer"||role==="Supervisor") && (
          <div>
            ...
            <input type="number" value={baseRate} onChange={e=>setBaseRate(e.target.value)}
              placeholder="e.g. 27" className="w-full border p-2 rounded"/>
          </div>
        )}
        ...
        <div className="flex items-center space-x-2">
          <input type="checkbox" checked={sTier} onChange={e=>setSTier(e.target.checked)}
            disabled={rating!=="Perfect"} className="w-5 h-5"/>
        ...
        <div className="space-y-2">
          ...
          {(role==="Driver"||role==="Trainer") && rating==="Perfect" && (
            <div className="flex items-center space-x-2">
              <input type="checkbox" checked={check39} onChange={e=>setCheck39(e.target.checked)} className="w-5 h-5"/>
          ...
          {(role==="Driver"||role==="Trainer") && rating==="Perfect" && ["A","B"].includes(tier) && (
            <div className="flex items-center space-x-2">
              <input type="checkbox" checked={checkLunch} onChange={e=>setCheckLunch(e.target.checked)} className="w-5 h-5"/>
      ...
      <div className="bg-white p-6 rounded-lg shadow space-y-4">
        ...
        <ul className="list-disc ml-6 space-y-1">
          ...
          <li>Hourly Bonus Total Pay (Max 40 hrs): ${weeklyBonusTotal}</li>
            ...
            <div>
              ...
              {showWR && (
                <div className="mt-1">
                  ...
                  <p><strong>Action Required:</strong> &lt;70%, or ≥3 minor flags or 1 major flag</p>
                </div>
              )}
            </div>
            {/* 3 */}
